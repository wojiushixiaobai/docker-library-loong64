...
[![Slack](https://slack.min.io/slack?type=svg)](https://slack.min.io) [![Docker Pulls](https://img.shields.io/docker/pulls/jumpserver/minio.svg?maxAge=604800)](https://hub.docker.com/r/jumpserver/minio/) [![license](https://img.shields.io/badge/license-AGPL%20V3-blue)](https://github.com/minio/minio/blob/master/LICENSE)
...
podman run -p 9000:9000 -p 9001:9001 \
  jumpserver/minio server /data --console-address ":9001"
```
