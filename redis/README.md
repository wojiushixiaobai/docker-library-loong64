...
-	[`7.0`, `7.0-buster`](https://github.com/wojiushixiaobai/docker-library-loong64/blob/master/redis/7.0/slim-buster/Dockerfile)
-	[`6.2`, `6.2-buster`](https://github.com/wojiushixiaobai/docker-library-loong64/blob/master/redis/6.2/slim-buster/Dockerfile)
-	[`6.0`, `6.0-buster`](https://github.com/wojiushixiaobai/docker-library-loong64/blob/master/redis/6.0/slim-buster/Dockerfile)
...
```console
$ docker run --name some-redis -d jumpserver/redis
```

## start with persistent storage

```console
$ docker run --name some-redis -d jumpserver/redis redis-server --save 60 1 --loglevel warning
```
...
```console
$ docker run -it --network some-network --rm jumpserver/redis redis-cli -h some-redis
```
...
```console
$ docker run -v /myredis/conf:/usr/local/etc/redis --name myredis jumpserver/redis redis-server /usr/local/etc/redis/redis.conf
```
