...
docker buildx build \
    ...
    --tag jumpserver/jenkins:lts-jdk17 \
    --tag jumpserver/jenkins:${JENKINS_VERSION}-lts-jdk17 \
    --push \
    .
...
docker buildx build \
    ...
    --tag jumpserver/jenkins:jdk17 \
    --tag jumpserver/jenkins:${JENKINS_VERSION}-jdk17 \
    --push \
    .
